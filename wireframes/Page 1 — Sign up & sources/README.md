# Page 1 — Sign up & sources — design reference
...
- `Artboard-5m3y.dc.html` — the artboard (a Design Component: an `<x-dc>`
...
Serve the folder (e.g. `python3 -m http.server`) and open `Artboard-5m3y.dc.html`;
